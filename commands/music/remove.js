...
module.exports = {
    ...
    options: [
        {
            name: "track",
            description: "Track / song position.",
            type: 4,
            required: true,
        }
    ],
    async execute(interaction, client) {
        ...
        const position = options.getInteger("track");
        ...
        if (player.paused) return interaction.reply({
            content: "🔸 |  Resume the player to remove songs.",
            ephemeral: true
        })
        ...
        const removeEmbed = new EmbedBuilder()
            .setColor("Blurple")
            .setDescription(`🔹 |  Removed song with positon of **${position}** [${member}]`)
            .setTimestamp()
